...
Shader "PBR/BRP_MaskMap" {
    Properties {
        ...
        _MetallicStrength ("MetallicStrength", Float ) = 1
        _AOStrength ("AOStrength", Float ) = 1
        _SmoothnessStrength ("SmoothnessStrength", Float ) = 1
